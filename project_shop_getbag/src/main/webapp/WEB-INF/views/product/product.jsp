...
<body>
  ...
  <div class="product mt-5">
    ...
    <div class="productItems">
      <div class="row">
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-wh1">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-wh2">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-wh3">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-wh4">
      ...
      <div class="row mt-3">
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-yw1">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-yw2">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-yw3">
          ...
          <a href="<%=request.getContextPath()%>/getbag/product-detail-yw4">
      ...
      <div class="row mt-3">
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-br1">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-br2">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-br3">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-br4">
      ...
      <div class="row mt-3">
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-bk1">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-bk2">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-bk3">
        ...
        <div class="col-3 p-0">
          <a href="<%=request.getContextPath()%>/getbag/product-detail-bk4">
