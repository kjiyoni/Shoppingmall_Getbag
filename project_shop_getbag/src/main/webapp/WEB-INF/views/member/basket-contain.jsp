...
<body>
  ...
  <div class="basket container">
    ...
    <div class="basketBox">
      ...
      <%
	  ArrayList<Product> list = (ArrayList<Product>)session.getAttribute("BasketList");
	  if (list == null) {
		  list = new ArrayList<>();
	  }
	  ...
	  %>
        <div class="row mb-5">
          ...
          <div class="col-3">
            <a href="/getbag/basket-remove?id=<%= product.getPid() %>"><p class="fw-bold text-end me-5">X</p></a>
          </div>
        </div>
        <% } %>
      </div>
